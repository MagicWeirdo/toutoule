function startGame() {
  ...
  function preload() {
    ...
    game.load.image("yiyadan", "/static/assets/yiyadan.png");
    game.load.image("shuang", "/static/assets/shuang.png");
    game.load.image("yiyashuang", "/static/assets/yiyashuang.png");
    ...
    game.load.image("ya1", "/static/assets/ya1.png");
    game.load.image("dice2", "/static/assets/dice_2.png");
    game.load.image("ya2", "/static/assets/ya2.png");
    game.load.image("dice3", "/static/assets/dice_3.png");
    game.load.image("ya3", "/static/assets/ya3.png");
    game.load.image("dice4", "/static/assets/dice_4.png");
    game.load.image("ya4", "/static/assets/ya4.png");
    game.load.image("dice5", "/static/assets/dice_5.png");
    game.load.image("ya5", "/static/assets/ya5.png");
    game.load.image("dice6", "/static/assets/dice_6.png");
    game.load.image("ya6", "/static/assets/ya6.png");
    game.load.atlasJSONHash("dice", "/static/assets/dice.png", "/static/assets/dice.json");
    game.load.image("resultDan", "/static/assets/result_dan.png");
    game.load.image("resultShuang", "/static/assets/result_shuang.png");
    game.load.image("result1", "/static/assets/result1.png");
    game.load.image("result2", "/static/assets/result2.png");
    game.load.image("result3", "/static/assets/result3.png");
