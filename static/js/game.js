function startGame() {
  ...
  function preload() {
    ...
    game.load.image("statusBanner", "/static/assets/time.png");
    game.load.image("bulletinBanner", "/static/assets/bulletin.png");
    game.load.image("buttonGroupBackground", "/static/assets/btn_bg.png");
    game.load.image("readyButton", "/static/assets/ready.png");
    game.load.image("alreadyButton", "/static/assets/have_readied.png");
    game.load.image("cancelButton", "/static/assets/cancel.png");
    game.load.image("playArea", "/static/assets/play_area.png");
    game.load.image("stakeArea", "/static/assets/stack_area.png");
    ...
    game.load.image("staked", "/static/assets/yiyazhu.png");
    game.load.image("back", "/static/assets/back.png");
    game.load.image("message", "/static/assets/message.png");
    game.load.image("transparent", "/static/assets/transparent.png");
    game.load.image("dice1", "/static/assets/dice_1.png");
    game.load.image("dice2", "/static/assets/dice_2.png");
    game.load.image("dice3", "/static/assets/dice_3.png");
    game.load.image("dice4", "/static/assets/dice_4.png");
    game.load.image("dice5", "/static/assets/dice_5.png");
    game.load.image("dice6", "/static/assets/dice_6.png");
    ...
    socket.on("result", function(data) {
      ...
      var waitInterval = setInterval(function() {
        if(numOffinished === 3) {
          ...
          // 显示用户是否成功
          if(stake.type === data.type) {
            gsResultText.visible = true;
            gsResultText.text = "成功";
          }else {
            gsResultText.visible = true;
            gsResultText.text = "失败";
          }
  ...
  function initGameScene() {
    ...
    gsDice1.animations.add("rotate", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6"], 6, true);
    gsDice1.animations.add("rotateTo1", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_1"], 7, false);
    gsDice1.animations.add("rotateTo2", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_2"], 7, false);
    gsDice1.animations.add("rotateTo3", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_3"], 7, false);
    gsDice1.animations.add("rotateTo4", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_4"], 7, false);
    gsDice1.animations.add("rotateTo5", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_5"], 7, false);
    gsDice1.animations.add("rotateTo6", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_6"], 7, false);
    ...
    gsDice2.animations.add("rotate", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6"], 6, true);
    gsDice2.animations.add("rotateTo1", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_1"], 7, false);
    gsDice2.animations.add("rotateTo2", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_2"], 7, false);
    gsDice2.animations.add("rotateTo3", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_3"], 7, false);
    gsDice2.animations.add("rotateTo4", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_4"], 7, false);
    gsDice2.animations.add("rotateTo5", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_5"], 7, false);
    gsDice2.animations.add("rotateTo6", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_6"], 7, false);
    ...
    gsDice3.animations.add("rotate", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6"], 6, true);
    gsDice3.animations.add("rotateTo1", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_1"], 7, false);
    gsDice3.animations.add("rotateTo2", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_2"], 7, false);
    gsDice3.animations.add("rotateTo3", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_3"], 7, false);
    gsDice3.animations.add("rotateTo4", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_4"], 7, false);
    gsDice3.animations.add("rotateTo5", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_5"], 7, false);
    gsDice3.animations.add("rotateTo6", ["dice_1", "dice_2", "dice_3", "dice_4", "dice_5", "dice_6", "dice_6"], 7, false);
    ...
    // dan button
    var danButton = game.add.button(baoziButton.width + displayWidth * 0.075, 0, "dan", function() {
      // 若允许押注
      if(allowStake) {
        stake.type = "d";
      }
